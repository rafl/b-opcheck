# This Makefile is for the B::OPCheck extension to perl.
#
...
INST_LIBDIR      = $(INST_LIB)/B
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/B
...
TO_INST_PM = lib/B/OPCheck.pm

PM_TO_BLIB = lib/B/OPCheck.pm \
...
# B::OPCheck might depend on some other libraries:
...
clean :: clean_subdirs
	- $(RM_F) \
	  ...
	  *$(OBJ_EXT) pm_to_blib \
	  $(INST_ARCHAUTODIR)/extralibs.ld OPCheck.c \
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/B/OPCheck.pm blib/lib/B/OPCheck.pm 
